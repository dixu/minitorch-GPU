    ...
    class Backend:
        ...
        class Sigmoid(Function):
            ...
            def backward(ctx, grad_output):
                # TODO: Implement for Task 2.4.
                a = ctx.saved_values
                tensor_ones = Tensor.make(
                                [1] * int(operators.prod(a.shape)), a.shape, backend=a.backend
                                )
                return mul_zip(mul_zip(sigmoid_map(a), (tensor_ones-sigmoid_map(a))), grad_output)
                #raise NotImplementedError('Need to implement for Task 2.4')
